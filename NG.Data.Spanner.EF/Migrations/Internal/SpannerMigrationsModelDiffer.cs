...
{
    public class SpannerMigrationsModelDiffer: MigrationsModelDiffer
    {
        ...
        public SpannerMigrationsModelDiffer(IRelationalTypeMapper typeMapper, IRelationalAnnotationProvider annotations, IMigrationsAnnotationProvider migrationsAnnotations) : base(typeMapper, annotations, migrationsAnnotations)
        {
        }
