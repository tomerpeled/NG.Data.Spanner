...
{
    public class WrappedSpannerDataReader: DbDataReader
    {
        private DbDataReader _reader;
        private bool _disposed;

        internal WrappedSpannerDataReader(DbDataReader reader)
        {
            _reader = reader;
        }
        ...
        {
            if (_reader == null)
                throw new ObjectDisposedException(nameof(WrappedSpannerDataReader));
            return _reader;
        }
    }
}
